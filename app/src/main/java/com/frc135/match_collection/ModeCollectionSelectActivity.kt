...
import com.frc135.match_collection.databinding.ModeCollectionSelectActivityBinding
import java.io.File

// Activity for selecting objective or subjective mode.
class ModeCollectionSelectActivity : CollectionActivity() {

    private lateinit var binding: ModeCollectionSelectActivityBinding
    ...
    private fun initButtonOnClicks() {
        binding.btnObjectiveCollectionSelect.setOnClickListener {
        ...
        binding.btnSubjectiveCollectionSelect.setOnClickListener {
            val newPressTime = System.currentTimeMillis()
            if (buttonPressedTime + 250 < newPressTime) {
                buttonPressedTime = newPressTime
        ...
        binding.btnPlayoffSelect.setOnClickListener {
            val newPressTime = System.currentTimeMillis()
            if (buttonPressedTime + 250 < newPressTime) {
                buttonPressedTime = newPressTime
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ModeCollectionSelectActivityBinding.inflate(layoutInflater)
        ...
        binding.tvVersionNumberModeSelect.text =
            getString(R.string.tv_version_num, Constants.VERSION_NUMBER)
        binding.tvEventName.text = getString(R.string.tv_event_name, Constants.EVENT_KEY)
        initButtonOnClicks()
    }
}
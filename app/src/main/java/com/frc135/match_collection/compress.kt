...
fun compress(
    ...
    val compressCageTop = objectiveData.getValue("cage_top").toString().split(",")[0]
    val compressCageMiddle = objectiveData.getValue("cage_middle").toString().split(",")[0]
    val compressCageBottom = objectiveData.getValue("cage_bottom").toString().split(",")[0]
    ...
    val compressDefenseRating =
        subjectiveData.getValue("defense_rating").toString().split(',')[0]
    ...
    if (collectionMode == Constants.ModeSelection.OBJECTIVE) {
        ...
        compressedMatchInformation =
            objectiveStartCharacter + compressedMatchInformation + genericSectionSeparator +
                    ...
                    compressCageTop + cageTopLevel + objectiveSeparator +
                    compressCageMiddle + cageCenterLevel + objectiveSeparator +
                    compressCageBottom + cageBottomLevel + objectiveSeparator +
    ...
    // Compress and add data specific to Subjective Match Collection.
        ...
        teamNumbers.forEachIndexed { i, teamNum ->
            ...
            val defense = getRankForTeam(defenseRating,teamNum)
            ...
            subjDataString += subjectiveSeparator
            subjDataString += compressDefenseRating
            subjDataString += defense.toString()

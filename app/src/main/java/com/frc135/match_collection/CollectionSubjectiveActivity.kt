...
import com.frc135.match_collection.Constants.Screens.COLLECTION_SUBJECTIVE
...
class CollectionSubjectiveActivity : CollectionActivity() {
    ...
    fun SubjectiveTeams(
        ...
        var teamOneDefenseRating by remember {
            mutableStateOf(
                intent.extras?.getInt("team_one_defense_rating")?.takeUnless { it == 0 } ?: 1)
        }
        var teamTwoDefenseRating by remember {
            mutableStateOf(
                intent.extras?.getInt("team_two_defense_rating")?.takeUnless { it == 0 } ?: 1)
        }
        var teamThreeDefenseRating by remember {
            mutableStateOf(
                intent.extras?.getInt("team_three_defense_rating")?.takeUnless { it == 0 } ?: 1)
        }
        // Layout
        Column(
            modifier = Modifier
            ...
            Row(
                ...
                Column(
                    ...
                    Text("Defense Rating")
                    CounterButton(
                        setCounterValue = { teamOneDefenseRating = it }, counterValue =
                        teamOneDefenseRating, defense = true
                    )
                    CounterButton(
                        setCounterValue = { teamTwoDefenseRating = it }, counterValue =
                        teamTwoDefenseRating, defense = true
                    )
                    CounterButton(
                        setCounterValue = { teamThreeDefenseRating = it }, counterValue =
                        teamThreeDefenseRating, defense = true
                    )
                }
                // Quickness inputs
                Column(
                ...
                Button(
                    onClick = {
                        ...
                        defenseRating = SubjectiveTeamRankings(
                            TeamRank(teamNumberOne, teamOneDefenseRating),
                            TeamRank(teamNumberTwo, teamTwoDefenseRating),
                            TeamRank(teamNumberThree, teamThreeDefenseRating)
                            )
                        ...
                        val intent = Intent(context, MatchInformationEditActivity::class.java)
                            ...
                            .putExtra("team_one_defense_rating", teamOneDefenseRating)
                            .putExtra("team_two_defense_rating", teamTwoDefenseRating)
                            .putExtra("team_three_defense_rating", teamThreeDefenseRating)
